...
if __name__ == '__main__':
    ...
    print(*lab_3_e.filter_requests(data), sep='\n')
    print('Zasoby pobierane pomiędzy 22 a 6 rano:')
    print(*lab_3_f.filter_download_time(data), sep='\n')
    print('Zasoby pobierane w piątek:')
    print(*lab_3_g.filter_download_date(data), sep='\n')
    print('Żądania z Polski (hostów z domeną zakończoną na .pl):')
    print(*lab_3_h.filter_download_location(data), sep='\n') """